...
The dsh-base bundle patch every profile applies first; mode bundles (dsh-web-app, dsh-headless, dsh-desktop-app) and the user's profile layer patch over it.
...
flowchart LR
  ...
  plugin_dsh_base_command_btw["command-btw<br/>@deepseek-ai/dsh-command-btw"]
  cfg --> plugin_dsh_base_command_btw
...
| `command-btw` | `@deepseek-ai/dsh-command-btw` |
