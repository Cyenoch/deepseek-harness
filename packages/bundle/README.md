...
| [`desktop-app/`](desktop-app/README.md) | Embedded Electron carrier over the shared Host and Web client graph | selects `electron` Connection transport and mounts `desktop-app` |
