...
本说明中的 GitHub 发布 job 与 Trusted Publisher 归属由[仅验证的 GitHub Actions](2026-08-14-validation-only-github-actions.md)取代。本说明继续负责四个 wheel 包的构建、兼容性、文件名、大小、元数据、哈希与平台标签验证要求。
