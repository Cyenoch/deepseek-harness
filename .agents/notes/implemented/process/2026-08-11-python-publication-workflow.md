...
The GitHub publication jobs and Trusted Publisher ownership described in this note are superseded by [validation-only GitHub Actions](2026-08-14-validation-only-github-actions.md). This note continues to own the four-wheel build, compatibility, filename, size, metadata, hash, and platform-tag validation requirements.
