...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  TerminalAttachRequest: 'terminal.md',
  TerminalAttachResult: 'terminal.md',
  TerminalInteractiveSession: 'terminal.md',
  TerminalReadRequest: 'terminal.md',
  TerminalReadResult: 'terminal.md',
  TerminalResizeResult: 'terminal.md',
  TerminalSendOperation: 'terminal.md',
  TerminalSendRequest: 'terminal.md',
  TerminalSessionId: 'terminal.md',
  TerminalSessionIdValue: 'terminal.md',
  ...
  TerminalStreamReadResult: 'terminal.md',
