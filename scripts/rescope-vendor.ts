...
const GENERIC_SKIPS: readonly GenericSkip[] = [
  ...
  // These files quote the product's `cordis/*` event namespace, Cordis plugin
  // ids, tool names, locale namespace, or preset id. None is an npm specifier.
  ...
  { file: 'scripts/smoke-desktop-native-module.ts', upstream: ['cordis'] },
]
