...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-sidepanel': { kind: 'none', reason: 'Browser-side UI plugin layer; renders logged command output and submits the /btw line through dsh-commands — nothing model-facing of its own.' },
